...
| `p5` or `adiless`               | Prototype 5 (B5xx) a.k.a. adi-less |

**Important**: when switching generations, do a full clean by running `rm -rf sdkconfig build`. Otherwise you will get _weird_ errors.
